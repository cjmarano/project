...
;; straight compiles or native compiles all packages by default.
;; (setq package-native-compile t)

(straight-use-package 'use-package)
(setq straight-use-package-by-default t)

;; straight says remove all require lines.
;; (require 'use-package)

;; $PATH is same in zsh and vterm
...
(setq org-todo-keywords
      '((sequence "TODO(t)" "NEXT(n)" "WAITING(w)" "|" "DONE(d)" "ISSUE(i)" "BROKEN(b)")
...
;; it appears rainbow-delimiters only enabled for lisp, elisp.
...
(custom-set-variables
 ...
 '(org-emphasis-alist
   '(("+" (:foreground "lightGreen")) ("/" italic)
     ("_" (:foreground "red")) ("=" org-verbatim verbatim) ("*" bold)
     ("~" org-code)))
