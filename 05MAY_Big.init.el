...
(custom-set-variables
 ...
 '(package-selected-packages
   '(0blayout 0xc @ all-the-icons-nerd-fonts auto-compile bind-key cargo
              ...
              diffview doom-modeline eglot exec-path-from-shell
              flycheck flycheck-eglot flycheck-pyflakes flycheck-rust
              flymake-ruff helpful hydra kkp lsp-ui lua-mode magit
