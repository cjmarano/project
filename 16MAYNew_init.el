...
(use-package consult-notes
  ...
  :config
  (setq consult-notes-file-dir-sources '(("Notes"  ?key  "~/project/org/notes/"))) 
  ;; Set org-roam integration, denote integration, or org-heading integration e.g.:
  (setq consult-notes-org-headings-files '("~/project/org/notes/file1.org"
                                           "~/project/org/notes/file2.org"))
...
(setq consult-notes-file-dir-sources
      '(("Org"             ?o "~/project/org/org-files/")
        ("Org Refile"      ?r "~/project/org/notebook/org-refile/")))
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(0blayout 0x0 all-the-icons-nerd-fonts auto-compile cargo cargo-mode
              color-theme-sanityinc-tomorrow company-box consult
              consult-notes corfu dashboard denote diffview
              ...
              paredit rainbow-delimiters rust-playground rustic
              show-font timu-macos-theme toml-mode tree-sitter-langs
