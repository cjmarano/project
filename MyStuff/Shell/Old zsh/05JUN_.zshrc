...
# export PATH=$PATH:/usr/local/sbin:/usr/local/bin:/usr/local/jamf/bin:/usr/bin:/bin:/usr/sbin:/sbin ~/.pyenv/versions/3.12.0/bin:~/.pyenv/shims/python
...
# Note: some of these replace aliases in the common-alias plugin.
...
#  export PATH="/Users/charles.marano/.pyenv/shims/pip:$PATH" 
