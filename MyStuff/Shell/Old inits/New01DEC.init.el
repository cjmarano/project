...
(custom-set-variables
 ...
 '(package-selected-packages
   '(0blayout 0xc @ all-the-icons all-the-icons-nerd-fonts auto-compile
              ...
              denote diffview dired-single dired-subtree doom-modeline
              eglot elpy exec-path-from-shell external-completion
              flycheck flycheck-pyflakes flycheck-rust flymake-ruff
