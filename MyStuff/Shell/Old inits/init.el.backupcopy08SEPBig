...
(custom-set-variables
 ...
 '(package-selected-packages
   '(0blayout 0x0 0xc all-the-icons all-the-icons-nerd-fonts
              auto-compile bind-key cargo cargo-mode
              color-theme-sanityinc-tomorrow company company-box consult
              consult-denote dashboard denote diffview dired-single
              dired-subtree doom-modeline eglot elisp-refs elpy
              exec-path-from-shell flycheck-pyflakes flycheck-rust
              helpful jsonrpc kkp lsp-ui lua-mode magit marginalia
              material-theme nerd-icons-completion nerd-icons-dired
              no-littering ob-rust orderless org-bullets org-roam
              paredit pfuture projectile rainbow-delimiters
              rustic seq show-font slime smartparens
              toml-mode track-changes tree-sitter-langs treemacs treesit-auto
