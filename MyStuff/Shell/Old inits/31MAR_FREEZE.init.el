...
(custom-set-variables
 ...
 '(flycheck-checkers
   '(lsp  c/c++-clang c/c++-gcc c/c++-cppcheck emacs-lisp
         emacs-lisp-checkdoc json-python-json json-jq  markdown-markdownlint-cli
         markdown-markdownlint-cli2 markdown-mdl markdown-pymarkdown
         org-lint python-flake8 python-ruff python-pylint python-pycompile python-pyright
         python-mypy ruby-rubocop ruby-chef-cookstyle ruby-standard ruby-reek ruby
         rust-cargo rust rust-clippy rustic-clippy sh-bash sh-posix-dash
         sh-posix-bash sh-zsh sh-shellcheck texinfo
         textlint yaml-actionlint yaml-jsyaml yaml-yamllint))
