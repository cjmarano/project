...
(add-to-list 'load-path "~/.emacs.d/elpa/slime-20260325.110")
...
(custom-set-variables
 ...
 '(flycheck-checkers
   '(lsp ada-gnat asciidoctor awk-gawk bazel-build-buildifier
         bazel-module-buildifier bazel-starlark-buildifier
         bazel-workspace-buildifier c/c++-clang c/c++-gcc
         c/c++-cppcheck cfengine coffee css-stylelint cuda-nvcc cwl
         d-dmd dockerfile-hadolint elixir-credo emacs-lisp
         emacs-lisp-checkdoc ember-template erlang-rebar3 erlang
         fortran-gfortran go-gofmt go-vet go-build go-test go-errcheck
         go-unconvert go-staticcheck groovy haml haml-lint handlebars
         haskell-stack-ghc haskell-ghc haskell-hlint html-tidy
         javascript-eslint javascript-oxlint javascript-standard
         ...
         nix opam org-lint perl perl-perlcritic perl-perlimports php
         php-phpmd php-phpcs php-phpcs-changed processing proselint
         protobuf-protoc pug puppet-parser puppet-lint python-flake8
         python-ruff python-pylint python-pycompile python-pyright
         python-mypy r-lintr r racket rpm-rpmlint rst-sphinx rst
         ruby-rubocop ruby-chef-cookstyle ruby-standard ruby-reek ruby
         rust-cargo rust rust-clippy rustic-clippy salt-lint scala
         scala-scalastyle scheme-chicken sass-stylelint scss-stylelint
         sh-bash sh-posix-dash sh-posix-bash sh-zsh sh-shellcheck slim
         slim-lint sql-sqlint statix systemd-analyze tcl-nagelfar
         terraform terraform-tflint tex-chktex tex-lacheck texinfo
         textlint verilog-verilator vhdl-ghdl xml-xmllint
         yaml-actionlint yaml-jsyaml yaml-yamllint))
 ...
 '(package-selected-packages
   '(0xc @ all-the-icons-nerd-fonts auto-compile bind-key cargo
         ...
         consult consult-denote dashboard denote diffview
         doom-modeline eglot exec-path-from-shell flycheck
         flycheck-eglot flycheck-pyflakes flycheck-rust flymake-ruff
         helpful hydra kkp lsp-ui lua-mode magit marginalia
         material-theme nerd-icons-completion nerd-icons-dired
         no-littering ob-rust orderless org-bullets org-roam paredit
         pyvenv rainbow-delimiters ruff-format rustic show-font slime
