...
(custom-set-variables
 ...
 '(package-selected-packages
   '(0xc @ all-the-icons-nerd-fonts auto-compile cargo cargo-mode
         color-theme-sanityinc-tomorrow company-box consult-denote
         dashboard diffview doom-modeline eglot exec-path-from-shell
         flycheck-pyflakes flycheck-rust flymake-ruff helpful kkp
         lsp-ui lua-mode magit marginalia material-theme modus-themes
         nerd-icons-completion nerd-icons-dired no-littering ob-rust
         orderless org-bullets org-roam paredit pyvenv
         rainbow-delimiters ruff-format rustic show-font slime
         smartparens toml-mode track-changes tree-sitter-langs
         treemacs treesit-auto use-package vertico vterm which-key))
