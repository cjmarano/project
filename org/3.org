* September.
* _Start times around 5 seconds, 7 for Big_, up from 3. 
...
* Show fonts (176-180 in init.el on New) does NOT show all fonts with C-c s f but does with C-c s t.
* Take another look at :defer :after etc. per System Crafters.
* lisp programming.
...
* Startup time for emacs on Plucky is 3 seconds.
