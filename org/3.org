...
* COMPLETED _Projects/org dir created with notes, roam, tasks, journal dirs and a copy of 3.org_
...
** how to start emacsclient from a need to do more research.
can do emacs -- daemon then emacsclient -c successfuly. Start time is 5+ secs.
