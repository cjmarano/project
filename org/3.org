...
* Terminal testing.
** Changed Wezterm theme to MaterialDesignColors but can't change background
...
iTerm2 - 3s. Kitty - instant. Ghostty - instant. wezterm - instant.
iTerm2 - fat, small icons. kitty -small icons. Ghostty small icons. Wezterm - small icons. - odd. MacOS specific?
** Changed all terms to 263238
this is from Martin Seeler's Material Design iTerm2 theme Material Design.
** Changed font on wezterm to JetBrainsMono Nerd Font.
Gave larger padding (space between lines) and larger icons, which is nice.
