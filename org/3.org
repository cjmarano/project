...
* COMPLETED commented out (setq org-indent-mode t) It's probably what's affecting init.el.orgmode
...
* NEXT Take another look at :defer :after etc. per System Crafters.
