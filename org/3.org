...
* Use bat, not cat, when syntax highlighting is important.
** alias cat to bat in .zshrc or make other aliases?xs
* Github Python branch not set up for https, couldn't update
