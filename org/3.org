...
* DONE Couldn't change cursor color using (setq-default cursor-color '"#00FF00")
...
* do I want consult-notes or consult-denote?
* _Projects/org dir created with notes, roam, tasks, journal dirs and a copy of 3.org_
* DONE init.el.org brought up to date to match init.el on New.
...
* zshrc - New wase using oh-my-zsh w/ p10k.
** New is now using same .zshrc as Plucky plus pyenv and some iterm2 integration, some other items.
** Big is using oh-my-posh w/o p10k.
** Plucky is using neither oh-my-posh nor oh-my-zsh.
